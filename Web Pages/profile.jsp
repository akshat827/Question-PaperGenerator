            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Menu</h3><!-- /.menu-title -->
                          ...
                          <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="index.html"> <i class="menu-icon fa fa-files-o"></i>Branch</a>

                    </li>  
                    <li class="active">
                        <a href="index.html"> <i class="menu-icon fa fa-book"></i>Subject</a>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            ...
            <div class="container">
                ...
                <label><b>Name  :</b></label> <%=hm.get("name") %><br><br>
                
                 <label><b>Email  :</b></label> <%=hm.get("email") %><br><br>
                  <label><b>Phone No  :</b></label> <%=hm.get("phone") %><br><br>
                  <% 
                   ...
                   if(m1==null){
                    ...
                    byte [] photo1 =db.getUserPhoto((String)hm.get("email"));
                      if(photo1.length!=0){
                      %>
                       <img src='GetPhoto.jsp?email=<%=hm.get("email")%>' width="130" height="150"  style="margin-left: 80%;">
                <%
                    }
%>
<button type ="button"class="btn-primary btn-block" style="width :250px;" href="editprofile.jsp"> <a href="editprofile.jsp" style="color:white">Edit Proile <a></button>
